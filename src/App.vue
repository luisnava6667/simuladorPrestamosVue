...
<template>
    <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
        ...
        <div class="my-5">
            <input type="range" class="w-full bg-gray accent-lime-500 hover:accent-lime-600" :min="min" :max="max"
            ...
            <select class="w-full bg-white border border-gray-300 rounded-lg text-center text-xl text-gray-500 mt-5"
        ...
        <p v-else class="text-center">Añade una candidad y un plazo a pagar</p>
    </div>
</template>
